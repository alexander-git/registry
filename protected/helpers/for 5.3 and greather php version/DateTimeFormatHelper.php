...
class DateTimeFormatHelper {
    ...
    public static function getDateTimeFromDBView($dateTimeDBView) {
        $date = DateTime::createFromFormat(self::DB_DATE_TIME_FORMAT, $dateTimeDBView);
        return $date;
    }
    
    public static function getDateTimeFromCommonTextView($dateTimeCommonTextView) {
        $date = DateTime::createFromFormat(self::COMMON_DATE_TIME_FORMAT, $dateTimeCommonTextView);
        return $date;   
    }
