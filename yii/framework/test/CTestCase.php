...
//require_once('PHPUnit/Runner/Version.php'); // закомментировано
//require_once('PHPUnit/Util/Filesystem.php'); // workaround for PHPUnit <= 3.6.11 // закомментировано

spl_autoload_unregister(array('YiiBase','autoload'));
//require_once('PHPUnit/Autoload.php'); // закомментировано
